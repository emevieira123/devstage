...
export function InputRoot({ error = false, ...props }: InputRootPros) {
  return (
    <div
      data-error={error}
...
interface InputIconPros extends ComponentProps<'span'> {}

export function InputIcon(props: InputIconPros) {
  return (
    <span
...
interface InputFieldPros extends ComponentProps<'input'> {}
